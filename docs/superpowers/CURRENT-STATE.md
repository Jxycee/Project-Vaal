...
Deliberate deferrals, each recorded with its reason in the relevant spec: rune sockets, item mods/affixes/rolls, a stat engine of any kind, import/export, and structured stat priorities.
...
| | |
|---|---|
| Unit (vitest, `node` env, no DOM harness) | **792 tests / 53 files** (2026-09-25, Slice 3 branch) |
| E2E (Playwright, mobile + desktop) | **69 passed, 1 skipped, 1 failed** on the Slice 3 full run (2026-09-25). The failure is below; that spec passed alone right after. Earlier: 67/68 and 68/68 on 2026-09-24 |
