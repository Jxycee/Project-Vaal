...
Deliberate deferrals, each recorded with its reason in the relevant spec: a stat engine of any kind (Slice 5), build export (import from PoB2 exists), and structured stat priorities.
