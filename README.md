...
- `public/data/wiki/<version>/` — wiki item/skill/mod data and icons, extracted from GGG's patch server via the MIT `@poe2-toolkit` extractors and regenerated by `npm run sync:wiki` (see `docs/superpowers/specs/2026-08-16-wiki-design.md`)
